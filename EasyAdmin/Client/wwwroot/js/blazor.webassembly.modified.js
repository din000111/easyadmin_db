!function (e) {
    ...
    , , , , , , , , , , , function (e, t, n) {
            ...
            return r(this, void 0, void 0, (function () {
                ...
                return o(this, (function (E) {
                    switch (E.label) {
                        case 0:
                            ...
                            return m = !0,
                                f.setEventDispatcher((function (e, t) {
                                    return DotNet.invokeMethodAsync("Microsoft.AspNetCore.Components.WebAssembly", "DispatchEvent", e, JSON.stringify(t))
                                }
                                )),
                                t = i.setPlatform(u.monoPlatform),
                                window.Blazor.platform = t,
                                window.Blazor._internal.renderBatch = function (e, t) {
                                    s.renderBatch(e, new c.SharedMemoryRenderBatch(t))
                                }
                                ,
                                n = window.Blazor._internal.navigationManager.getBaseURI,
                                l = window.Blazor._internal.navigationManager.getLocationHref,
                                ...
                                window.Blazor._internal.navigationManager.getUnmarshalledLocationHref = function () {
                                    return BINDING.js_string_to_mono_string(l())
                                }
                                ,
                                window.Blazor._internal.navigationManager.listenForNavigationEvents((function (e, t) {
                                    return r(w, void 0, void 0, (function () {
                                        return o(this, (function (n) {
                                            switch (n.label) {
                                                case 0:
                                                    return [4, DotNet.invokeMethodAsync("Microsoft.AspNetCore.Components.WebAssembly", "NotifyLocationChanged", e, t)];
                                                case 1:
                                                    return n.sent(),
                                                        [2]
                                            }
                                ...
                                [4, h.BootConfigResult.initAsync()];
                        case 1:
                            return v = E.sent(),
                                [4, Promise.all([d.WebAssemblyResourceLoader.initAsync(v.bootConfig, e || {}), p.WebAssemblyConfigLoader.initAsync(v)])];
                        case 2:
                            y = a.apply(void 0, [E.sent(), 1]),
                                b = y[0],
                                E.label = 3;
                        case 3:
                        ...
                        case 5:
                            throw g = E.sent(),
                            new Error("Failed to start platform. Reason: " + g);
                        case 6:
                            return t.callEntryPoint(b.bootConfig.entryAssembly),
                                [2]
                    }
                }
                ))
        ...
        window.Blazor.start = v,
            l.shouldAutoStart() && v().catch((function (e) {
    ...
    , function (e, t, n) {
        ...
        var a, i = n(48), u = n(32), s = n(49), c = Math.pow(2, 32), l = Math.pow(2, 21) - 1;
        function f(e) {
            ...
            start: function (e) {
                return new Promise((function (t, n) {
                    ...
                    i.attachDebuggerHotkey(e),
                            ...
                            window.Module = function (e, t, n) {
                                ...
                                f.print = function (e) {
                                    ...
                                    f.printErr = function (e) {
                                        console.error(e),
                                            u.showErrorNotification()
                                    }
                                    ,
                                    f.preRun = f.preRun || [],
                                    f.postRun = f.postRun || [],
                                    f.preloadPlugins = [];
                                var v, y = e.loadResources(l.assembly, (function (e) {
                                    return "_framework/_bin/" + e
                                }
                                ), "assembly"), b = e.loadResources(l.pdb || {}, (function (e) {
                                    return "_framework/_bin/" + e
                                }
                                ), "pdb"), g = e.loadResource("dotnet.wasm", "_framework/wasm/dotnet.wasm", e.bootConfig.resources.runtime["dotnet.wasm"], "dotnetwasm");
                                return e.bootConfig.resources.runtime.hasOwnProperty("dotnet.timezones.dat") && (v = e.loadResource("dotnet.timezones.dat", "_framework/wasm/dotnet.timezones.dat", e.bootConfig.resources.runtime["dotnet.timezones.dat"], "timezonedata")),
                                    f.instantiateWasm = function (e, t) {
                                    ...
                                    f.preRun.push((function () {
                                        a = cwrap("mono_wasm_add_assembly", null, ["string", "number", "number"]),
                                            ...
                                            window.Blazor._internal.dotNetCriticalError = function (e) {
                                                f.printErr(BINDING.conv_string(e) || "(null)")
                                            }
                                            ,
                                    ...
                                    f.postRun.push((function () {
                                        ...
                                        e.bootConfig.debugBuild && e.bootConfig.cacheBootResources && e.logToConsole(),
                                            ...
                                            cwrap("mono_wasm_load_runtime", null, ["string", "number"])("appBinDir", i.hasDebuggingEnabled() ? -1 : 0),
                                            MONO.mono_wasm_runtime_ready(),
                                            n = h("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "InvokeDotNet"),
                                            r = h("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "BeginInvokeDotNet"),
                                            o = h("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Services.DefaultWebAssemblyJSRuntime", "EndInvokeJS"),
                        ...
                        window.__wasmmodulecallback__ = c,
                        l.type = "text/javascript",
                        l.text = "var Module; window.__wasmmodulecallback__(); delete window.__wasmmodulecallback__;",
                        document.body.appendChild(l)
                }
                ))
            },
            callEntryPoint: function (e) {
                h("Microsoft.AspNetCore.Components.WebAssembly", "Microsoft.AspNetCore.Components.WebAssembly.Hosting.EntrypointInvoker", "InvokeEntrypoint")(e, null)
            },
            ...
            t.attachDebuggerHotkey = function (e) {
                ...
                a() && console.info("Debugging hotkey: Shift+" + t + "+D (when application has focus)"),
                    document.addEventListener("keydown", (function (e) {
                        var t;
                        e.shiftKey && (e.metaKey || e.altKey) && "KeyD" === e.code && (o ? r ? ((t = document.createElement("a")).href = "_framework/debug?url=" + encodeURIComponent(location.href),
                            t.target = "_blank",
